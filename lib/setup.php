 ...
 * Red Thread Creative
 *
 * @package     RedThreadCreative\RedThreadChild
 * @since       1.0.2
 * @author      redthreadollie
 * @link        https://www.redthreadcreative.co.uk
 * @license     GNU General Public License 2.0+
 */
namespace RedThreadCreative\RedThreadChild;
...
add_action( 'after_setup_theme', __NAMESPACE__ . '\load_theme_localization_setup' );
/**
 ...
 * @return void
 */
function load_theme_localization_setup(){
